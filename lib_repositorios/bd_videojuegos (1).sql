...
CREATE TABLE Auditorias(
	Id INT IDENTITY(1,1) CONSTRAINT	id_auditorias PRIMARY KEY,
...
CREATE TABLE Permisos(
	Id INT CONSTRAINT id_permisos PRIMARY KEY IDENTITY(1,1), 
	Descripcion VARCHAR(100) NOT NULL,
	Activo BIT NOT NULL
);
GO
CREATE TABLE Roles_Permisos(
	Id INT CONSTRAINT id_permisosroles PRIMARY KEY IDENTITY(1,1), 
	Rol INT CONSTRAINT fk_roles foreign key REFERENCES Roles(id),
	Permiso INT CONSTRAINT fk_permisos REFERENCES Permisos(id)
);
GO
...
CREATE TABLE Videojuegos (
	...
	Desarrollador INT FOREIGN KEY REFERENCES Usuarios(Id) NOT NULL,
	Imagen VARCHAR(MAX)
);
GO
